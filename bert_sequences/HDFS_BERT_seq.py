...
def build_encoder_sequences(events_df, traces_df, join_cols=("EventTemplate",), order_cols=("LineId", "TID")):
    df = events_df.copy()

    # Sort by TaskID then LineId then TID (Order events in Trace)
    if order_cols:
